...
public class ProtestanMapActivity extends AppCompatActivity implements LocationListener {
            ...
            for (int i = 0; i < permissions.length; i++) {
                ...
                if (permission.equals(Manifest.permission.ACCESS_FINE_LOCATION)) {
                    if (grantResult == PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(ProtestanMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 115);
                    }
                }
            }
        }
